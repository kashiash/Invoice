    ...
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXafWebApi(options => {
                ...
                options.BusinessObject<ProductGroup>();
            });
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "Invoice API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the Invoice.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
                    ...
                    Flows = new OpenApiOAuthFlows() {
                        AuthorizationCode = new OpenApiOAuthFlow() {
                            ...
                            Scopes = new Dictionary<string, string> {
                                ...
                                { @"[Enter the scope name in the Invoice.Blazor.Server\Startup.cs file]", @"[Enter the scope description in the Invoice.Blazor.Server\Startup.cs file]" }
                            }
                        }
                    }
                });
