...
This project implements an ASP.NET Core Web API application (https://docs.devexpress.com/eXpressAppFramework/403394/backend-web-api-service?v=21.2).
The root project folder contains the WebApiApplication.cs file with the class that inherits
...
https://docs.devexpress.com/eXpressAppFramework/403394/backend-web-api-service?v=21.2
