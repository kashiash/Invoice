...
namespace Invoice.WebApi {
    public partial class InvoiceWebApiApplication : BlazorApplication {
        public InvoiceWebApiApplication() {
            InitializeComponent();
        }
        ...
        private void InvoiceWebApiApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
