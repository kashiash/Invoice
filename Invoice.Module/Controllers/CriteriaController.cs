...
namespace JK.XAF.Module.Controllers
{
    public class CriteriaController : ViewController<ListView>
    {
        ...
        private void FilteringCriterionAction_Execute(object sender, SingleChoiceActionExecuteEventArgs e)
        {
            ...
            //View.Model.Criteria = data;
            //View.LoadModel(true);

            View.CollectionSource.BeginUpdateCriteria();
            View.CollectionSource.Criteria.Clear();
            View.CollectionSource.Criteria[e.SelectedChoiceActionItem.Caption] =
               CriteriaEditorHelper.GetCriteriaOperator(
                e.SelectedChoiceActionItem.Data as string,
        ...
        private void RefreshActionItems()
        {
            ...
            {
                if (criterion.ObjectType != null && criterion.ObjectType.IsAssignableFrom(View.ObjectTypeInfo.Type) && (criterion.AllowPublic || criterion.OwnerName == SecuritySystem.CurrentUserName))
                {
