...
namespace Invoice.Win {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Win.WinApplication._members
    public partial class InvoiceWindowsFormsApplication : WinApplication {
        public InvoiceWindowsFormsApplication() {
			InitializeComponent();
        ...
        private void InvoiceWindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e) {
